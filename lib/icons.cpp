...
Icons::Icons(const Version &version)
    : Canvas(version.Pictures.Get(PictureIndex::Icons)),
      ...
      ScrollbarThumbTopPart(Canvas, 220, 64, 12, 5),
      ScrollbarThumbMiddlePart(Canvas, 220, 69, 12, 1),
      ScrollbarThumbBottomPart(Canvas, 220, 70, 12, 6),
      ScrollbarBackground(Canvas, 264, 0, 12, 96),

      BorderCornerLight(Canvas, 98, 197, 2, 2),
      BorderHorizontalLight(Canvas, 2, 197, 96, 2),
      BorderCornerLightDark(Canvas, 100, 197, 2, 2),
      BorderVerticalLight(Canvas, 276, 0, 2, 96),
      BorderVerticalDark(Canvas, 0, 98, 2, 96),
      BorderHorizontalDark(Canvas, 0, 96, 96, 2),
      BorderCornerDark(Canvas, 100, 199, 2, 2),

      ChatBackgroundDarkLeft(Canvas, 210, 182, 2, 16),
      ChatBackgroundDark(Canvas, 212, 182, 96, 16),
      ChatBackgroundDarkRight(Canvas, 308, 182, 2, 16),
      ...
      ChatMessageBorderTopRight(Canvas, 101, 201, 3, 3),
      ChatMessageBorderBottomLeft(Canvas, 98, 204, 3, 3),
      ChatMessageBorderBottomRight(Canvas, 101, 204, 3, 3),
      ChatTalkButton(Canvas, 274, 114, 16, 16),
